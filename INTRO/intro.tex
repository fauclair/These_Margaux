...
Le Seuil de Camarinal est l'accident bathymétrique le moins profond du détroit et sert de barrière à franchir pour les eaux méditerranéennes qui circulent sous les eaux atlantiques et vont s'écouler comme un courant de gravité ne foid franchis cet obstacle. \citep{wesson_1994,garcia-lafuente_2011}
...
%Des eaux atlantiques entrent en Méditerranée dans la partie supérieure de la colonne d'eau. Sous cette circulation de surface, des eaux méditerranéennes s'introduisent dans le bassin Atlantique. 




%Au niveau des flux entrant et sortant propres, cette circulation moyenne est de l'ordre de $1 Sverdrup (=10^6 m^3/s)$ 
