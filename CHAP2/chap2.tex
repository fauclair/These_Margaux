...
For a linear approximation of the equation of state, a simple evolution equation of $\rho$ can be obtained as a combination of equations \ref{NS_c} and \ref{NS_d} leading to:\color{red} (eq utilisée pour développement BPE (et ailleurs?) XC : incompressible faut le complet... (mettre els deux) (combinaison des deux équations faut le mettre complet))\color{black}
\begin{equation}
\displaystyle
\frac{d \rho}{d t}=
