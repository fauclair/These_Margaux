...
Another consequence of our protocol is that this effective diffusivity value has contributions on timescales of other dynamical processes, including ones that would not reflect diapycnal mixing (such as reaching negative values, whereas mixing is supposed to be an irreversible process). This is the case even when rearrangement is made over small sub-domain, as the advection time of structures is usually small compared to the timescales of diffusive processes. So an instantaneous evaluation of effective diffusion does not reflect the dynamical adjustment of the advected structures due to mixing.

Here time-averaging of the value of effective diffusivity was used to retrieve coefficients more representative of processes over long time periods, but it may be more astucious to integrate the time-averaging process to the balance equation itself.
...
Finally, this study only considers the BPE subdivision of the gravitational potential energy of the ocean. More information on the underlying effects of the simulated dynamics on the evolution of BPE and diabatic mixing could be gathered by evaluating transfers with and between other energy compartment, such as the kinetic energy of the flow.
\color{black}
