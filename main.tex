...
Sensitivity of the turbulent eddies' development, and thus sensitivity of water masses' properties, to subgrid closure scheme is also addressed.

The final chapter of this manuscript revolves around the quantification of mixing based on the evolution of potential energy. A new term is added to the balance equation of this quantity to take into account the evolution of volume with free surface movements. Evaluation of the balance in increasingly complex and realistic flows proves this term to be non-negligible, highlighting its importance when evaluating mixing with accuracy.
...
\begin{table}[!h]
        ...
        %\begin{tabular}{\linewidth}{@{\extracolsep{\fill}}|c|ll|}
                ...
                \hline
                WMDW & West Mediterranean Deep Water & Eau profonde du bassin ouest-Méditerranée\\
                \hline
        \end{tabular}
