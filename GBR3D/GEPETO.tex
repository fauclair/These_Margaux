...
In section \ref{sectionSim2D}, SVD was applied to the complex field of $\psi=w+iu$. %consecutive vectors of the basis with close singular value and that exhibited similar time-variations were combined to ... .
